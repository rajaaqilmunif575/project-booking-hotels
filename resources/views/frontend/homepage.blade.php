  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="./index.html">BOKING HOTEL</a>
        <button
    ...
    <header class="bg-dark py-5">
      <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
          <h1 class="display-4 fw-bolder">Sewa hotel</h1>
    ...
    <section class="py-5">
      <div class="container px-4 px-lg-5 mt-5">
        <h3 class="text-center mb-5">HOTEL</h3>
        <div
            ...
            <div class="card h-100">
              ...
              <div class="card-body card-body-custom pt-4">
                <div class="text-center">
                  <!-- Product name-->
                  <h5 class="fw-bolder">Special hotel</h5>
                  <!-- Product price-->
                  ...
                  <ul class="list-unstyled list-style-group">
                    ...
                    >
                      ...
                      <span style="font-weight: 600">VVIP</span>
                    </li>
                    <li
                      class="border-bottom p-2 d-flex justify-content-between"
                    >
                    ...
                    >
                      ...
                      <span style="font-weight: 600">ready</span>
                    </li>
                  </ul>
                </div>
              </div>
